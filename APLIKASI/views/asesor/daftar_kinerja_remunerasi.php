<script type="text/javascript">
		$(document).ready(function () {
		    ...
		    $("#btn_save").click(function(){
				...
				$.ajax({
					url: "<?php echo base_url('bkd/dosen/verifikator/update_status_verifikasi_remun')?>",
					type: "POST",
					...
					success: function(result){
						...
						console.log(id);
						console.log(kom);
						window.location = "http://akademik.uin-suka.ac.id/bkd/dosen/verifikator/remunerasi_dosen/";
					}
				});
