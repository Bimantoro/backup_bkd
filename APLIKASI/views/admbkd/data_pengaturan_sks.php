...
<script type="text/javascript">
	...
	function get_keterangan(){
		$.ajax({
			url 	: '<?php echo base_url(); ?>/bkd/admbkd/setting/get_keterangan',
			type 	: 'GET',
			data 	: '',
...
<body>
	<div>
		...
		<table class="table noborder">
			<tr>
				<td colspan="2"><h3>Kelompok Pengaturan</h3></td>
			</tr>
			<tr>
				<td>	
					<table class="table noborder">
			...
			<tr>
				<td colspan="2"><h3>Formulir Pengaturan Nilai SKS</h3></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td>					
					<table class="table noborder">
							<tr hidden>
								<td>ID_RULE</td>
								<td><input type="number" name="id_rule" id="id_rule"></td>
							</tr>
						<tr>
							<td style="width: 70px;">Mode</td>
							<td>
						...
						<tr>
							<td>Batas</td>
							<td>
								<input type="number" name="batas" id="batas" step="any" min='0.001'>
							</td>
						</tr>
					</table>
				<td>
		...
		<div id="konten">
			<h3>Data Pengaturan Nilai SKS</h3>		
